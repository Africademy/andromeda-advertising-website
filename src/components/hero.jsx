      ...
      <main className="hero">
        ...
        <section className="hero__welcome">
          <section className="hero__welcome__text">
            <h1 className="hero__welcome__text__title">
              Advertising your brands
            </h1>
            <p className="hero__welcome__text__description">
              Creativity without strategy is called art, <br />
              creative with strategy is called advertising
            </p>
            <button className="hero__welcome__text__btn">
              Create campaign
              <span>
                <svg
                  width={30}
