    ...
    return (
      <main className="services">
        ...
        <p className="services__description">
          The more users will trust us, the better we will be in. So all we need
          is your help. The better we will be in. So all we need is your help.
        </p>
        ...
        <section id="trigger-testimonials" className="services__action">
          <h2 className="services__action__title">
            Create your campaign with few steps
          </h2>
          <p className="services__action__description">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam semper
            dui eget sem rhoncus, nec rutrum tortor aliquam.
          </p>
          <button className="services__action__btn">
            Get started
            <span>
              <svg
                width={30}
