...
class Contact extends Component {
  ...
  validateEmail = (e) => {
    this.state.email === ""
      ? this.setState({ emailIsFilled: false })
      : this.setState({ emailIsFilled: true });
  };
  validateMessage = (e) => {
    this.state.message === ""
      ? this.setState({ messageIsFilled: false })
      : this.setState({ messageIsFilled: true });
  };
  validateForm = () => {
    ...
    return (
      <main className="contact">
        <section className="contact__head">
          ...
          <p className="contact__head__description">
            If you want to collab with us, feel free to contact us
          </p>
        </section>
        <section className="contact__form-and-map">
          ...
          <form
            ...
            className="contact__form-and-map__form"
          >
            <h2 className="contact__form-and-map__form__title">
            ...
            <section className="contact__form-and-map__form__inputs">
              <section className="contact__form-and-map__form__inputs__fullname">
                ...
                <input
                  onKeyDown={(e) => this.validateName(e)}
              ...
              <section className="contact__form-and-map__form__inputs__email">
                ...
                <input
                  onKeyDown={(e) => this.validateEmail(e)}
                  onChange={(e) => this.handleInput(e)}
              ...
              <section className="contact__form-and-map__form__inputs__message">
                ...
                <textarea
                  onKeyDown={(e) => this.validateMessage(e)}
                  onChange={(e) => this.handleInput(e)}
              ...
              {this.state.formIsFilled === false ? (
                ...
                <button className="contact__form-and-map__form__inputs__btn">
                  Send message
                  <span>
                    <svg
                      width={30}
